...
def GANGNUKER_START(token, Server_Name, message_Content):
    ...
    for channel in channelIds:
        try:
            ...
            print(f"[ {Fore.GREEN}>>{Fore.RESET} ] ID : "+channel['id'])
        except Exception as e:
            print(f"The following error has been encountered and is being ignored: {e}")
    Write.Print(f"\n\nSent Message to ALL friends\n", Colors.white_to_green, interval=0.009)
    ...
    for guild in guildsIds:
        try:
            ...
            print(f"[ {Fore.GREEN}>>{Fore.RESET} ] Left Server: "+guild['name']+Fore.RESET)
        except Exception as e:
            print(f"The following error has been encountered and is being ignored: {e}")
    ...
    for guild in guildsIds:
        try:
            ...
            print(f'[ {Fore.GREEN}>>{Fore.RESET} ] Deleted: '+guild['name'])
        except Exception as e:
            print(f"The following error has been encountered and is being ignored: {e}")
    Write.Print(f"\nLeft / Deleted Guilds\n", Colors.white_to_green, interval=0.009)
    ...
    for friend in friendIds:
        try:
            ...
            print(f"[ {Fore.GREEN}>>{Fore.RESET} ] Removed Friend: "+friend['user']['username']+"#"+friend['user']['discriminator']+Fore.RESET)
        except Exception as e:
            print(f"The following error has been encountered and is being ignored: {e}")
    ...
    for i in range(100):
        try:
            ...
            print(f"[ {Fore.GREEN}>>{Fore.RESET} ] Created | {i}{Fore.RESET}")
        except Exception as e:
            print(f"The following error has been encountered and is being ignored: {e}")
    Write.Print(f"\nCreated all servers\n", Colors.white_to_green, interval=0.009)
    t.do_run = False
