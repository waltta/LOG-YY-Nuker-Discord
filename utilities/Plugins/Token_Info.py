...
[{Fore.GREEN}Username{Fore.RESET}]        {userName} | {userID}
[{Fore.GREEN}Badges{Fore.RESET}]          {badges}
[{Fore.GREEN}Language{Fore.RESET}]        {language}
[{Fore.GREEN}Created at{Fore.RESET}]      {creation_date}
[{Fore.GREEN}Avatar URL{Fore.RESET}]      {avatar_url if avatar_id else ""}
[{Fore.GREEN}Account Token{Fore.RESET}]   {Fore.RED}{token}{Fore.RESET}
...
[{Fore.GREEN}Nitro Status{Fore.RESET}]    {has_nitro}
[{Fore.GREEN}Expires in{Fore.RESET}]      {days_left if has_nitro else "0"} day(s)
            ''')
